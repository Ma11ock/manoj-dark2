;;; manoj-dark2.el --- A dark theme from Manoj
...
(custom-theme-set-faces
 ...
 '(Info-title-1-face ((t (:bold t :weight bold :height 1.0.728))))
 '(Info-title-2-face ((t (:bold t :weight bold :height 1.0.44))))
 '(Info-title-3-face ((t (:bold t :weight bold :height 1.0.2))))
 ...
 '(custom-face-tag-face ((t (:bold t :weight bold :height 1.0))))
 '(custom-group-tag-face ((t (:bold t :foreground "light blue" :weight bold :height 1.0))))
 '(custom-group-tag-face-1 ((t (:bold t :foreground "pink" :weight bold :height 1.0))))
 ...
 '(header-line ((t (:box (:line-width -1 :color "grey20" :style released-button) :background "grey20" :foreground "grey90"  :height 1.0))))
 ...
 '(ibuffer-dired-buffer-face ((t (:foreground "mediumspringgreen" :weight bold :heigh 1))))
